...
if (!defined('NOT_FOUND_IMAGE')) define('NOT_FOUND_IMAGE', 'https://alpha3.mytechnology.ae/travel/images/no-image.png');                            // Image to serve if any 404 occurs

if (!defined('ERROR_IMAGE')) define('ERROR_IMAGE', 'https://alpha3.mytechnology.ae/travel/images/no-image.png');                                // Image to serve if an error occurs instead of showing error message
...
if (!defined('LOCAL_FILE_BASE_DIRECTORY')){
    if (strpos($_SERVER['DOCUMENT_ROOT'], 'xampp')){
        define('LOCAL_FILE_BASE_DIRECTORY', 'C:\xampp\htdocs\paddle-stadium\public');
    }else{
        define('LOCAL_FILE_BASE_DIRECTORY', $_SERVER['DOCUMENT_ROOT']);
    }
}
