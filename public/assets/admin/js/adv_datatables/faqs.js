var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $("#manage-faqs").mDatatable({
            data: {
                type: "remote",
                source: {read: {url: window.Laravel.baseUrl+"list/faqs"}},
                pageSize: 10,
            ...
            columns:
                [
                    ...
                    {field: "name_en", title: "Title(Englsih)",  width: 250},
                    {field: "name_ar", title: "Title(Arabic)",  width: 250},
