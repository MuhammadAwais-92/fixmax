var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $("#manage-pages").mDatatable({
            data: {
                type: "remote",
                source: {read: {url: window.Laravel.baseUrl+"list/services"}},
                pageSize: 10,
            ...
            columns:
                [
                    ...
                    {field: "en_name", title: "Title(english)",  width: 150},
                    {field: "ar_name", title: "Title(arabic)",  width: 150},
                    {field: "discount", title: "Discount Percentage",  width: 150},
                    // {field: "average_rating", title: "Rating",  width: 150},
                    {field: "supplier_name", title: "Supplier Name",  width: 150},
                    {field: "min_price", title: "Min Price",  width: 150},
                    {field: "max_price", title: "Max Price",  width: 150},
                    {field: "Activate", title: "Active",  width: 150},
                    {field: "category", title: "Service Category",  width: 150},
