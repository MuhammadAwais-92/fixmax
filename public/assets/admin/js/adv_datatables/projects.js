var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $("#manage-pages").mDatatable({
            data: {
                type: "remote",
                source: {read: {url: window.Laravel.baseUrl+"list/projects"}},
                pageSize: 10,
        ...
        t.on('m-datatable--on-layout-updated', function(params){
            ...
            bindToggleAction(t);
                $('.activate-record-button').on('click', function(e) {
                    ...
                    swal({
                            title: "Are you sure you want to active this project?",
                            type: "warning",
                            showCancelButton: true,
                            confirmButtonColor: "#1C4670",
                ...
                $('.deactivate-record-button').on('click', function(e) {
                    ...
                    swal({
                            title: "Are you sure you want to de-active this project?",
                            type: "warning",
                            showCancelButton: true,
                            confirmButtonColor: "#1C4670",
                            confirmButtonText: "yes",
