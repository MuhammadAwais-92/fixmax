var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $("#manage-articles").mDatatable({
            data: {
                type: "remote",
                source: {read: {url: window.Laravel.baseUrl+"list/articles"}},
                pageSize: 10,
            ...
            columns:
                [
                    ...
                    {field: "name", title: "Nmae",  width: 250},
                    {field: "content", title: "Content",  width: 250},
