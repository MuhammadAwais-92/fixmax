var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $("#manage-pages").mDatatable({
            data: {
                type: "remote",
                source: {read: {url: window.Laravel.baseUrl+"list/equipments"}},
                pageSize: 10,
        ...
        t.on('m-datatable--on-layout-updated', function(params){
            ...
            bindToggleAction(t);
                $('.activate-record-button').on('click', function(e) {
                    ...
                    swal({
                            title: "Are you sure you want to activate this equipment?",
                            type: "warning",
                            showCancelButton: true,
                            confirmButtonColor: "#1C4670",
                ...
                $('.deactivate-record-button').on('click', function(e) {
                    ...
                    swal({
                            title: "Are you sure you want to deactive this equipment?",
                            type: "warning",
                            showCancelButton: true,
                            confirmButtonColor: "#1C4670",
                            confirmButtonText: "Yes",
