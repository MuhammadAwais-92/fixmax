// Define variable
def PATH = "/var/www/html/alpha3/fixmax"
  ...
  stages {
    ...
    stage('PERMISSIONS SETUP') {
      steps {
          ...
          sh "sudo chmod -R 777 ${PATH}/storage"

          // Set permissions for Cache Directory
          sh "sudo chmod -R 777 ${PATH}/bootstrap/cache"
    ...
    environment {
        ...
        EMAIL_TO = 'danish.s@mytechnology-team.com, a.haseeb@mytechnology-team.com'
    }
