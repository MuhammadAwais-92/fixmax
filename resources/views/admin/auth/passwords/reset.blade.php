    ...
    <div class="">
        ...
        <form class="m-login__form m-form" action="{!! route('admin.auth.forgot-password.reset') !!}" method="post">
            ...
            <div class="form-group m-form__group">
                ...
                <input class="form-control m-input" type="email" placeholder="Email" name="email" id="m_email" autocomplete="off" required value="{{ old('email',$email) }}">
            ...
            <div class="form-group m-form__group">
                ...
                <input class="form-control m-input" type="password" minlength="6" placeholder="Password" name="password" id="m_email" autocomplete="off" required>
            ...
            <div class="form-group m-form__group">
                ...
                <input class="form-control m-input" type="password" minlength="6" placeholder="Confirm Password" name="password_confirmation" id="m_email" autocomplete="off" required>
