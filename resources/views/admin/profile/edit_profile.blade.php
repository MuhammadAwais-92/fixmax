                    ...
                    <div class="tab-pane active" id="m_user_profile_tab_1">
                        ...
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-7">
                                    {!! Form::text('name', old('name',$admin['name']),['class' => 'form-control', 'id' => 'full_name', 'placeholder' => 'Full Name', 'required' => 'required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-7">
                                    {!! Form::text('email', old('email', $admin['email']), ['class' => 'form-control', 'id' => 'email', 'placeholder' => 'Email', 'required' => 'required']) !!}
                                </div>
                            </div>
