            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    <div class="col-xl-12 order-2 order-xl-1">
                        <form class="form-group m-form__group row align-items-center" action="" id="manage-agency-search">
                                        ...
                                        <select class="form-control mt-select2" id="store_name" name="store_name">
                                            ...
                                            @forelse($stores as $store)
                                                @if (isset($store->storeSubscription))
                                                    @if ($store->storeSubscription->forMultipleBranch())
                                                        <option value="{{ $store->id }}">
                                                            {{ translate($store->store_name) }}</option>
                                                    @endif
                                                @endif
                                            @empty
                                            @endforelse
                            ...
                            <div class="col-md-4 m--margin-bottom-10">
                                <div class="m-form__group m-form__group--inline">
                                    ...
                                    <div class="m-form__control">
                                        <input type="text" class="form-control m-bootstrap-select" name="supplier_name" placeholder="Supplier Name">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 m--margin-bottom-10">
                                <div class="m-form__group m-form__group--inline">
                                    ...
                                    <div class="m-form__control">
                                        <input type="text" class="form-control m-bootstrap-select" name="status"
                                            placeholder="Status">
                                    </div>
                                </div>
                            </div>
