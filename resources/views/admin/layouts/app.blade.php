...
<head>
    ...
    <link rel='icon' href="{!! asset('assets/front/img/favcon.png') !!}" type='image/x-icon'/>
    <script>
        WebFont.load({
...
<script type="text/javascript">
    ...
    }, "Please enter international number starting with + sign OR 00.");

    jQuery.validator.addMethod("spaceNotAllowed", function (value, element) {
        return this.optional(element) || /.*\S.*/.test(value);
    }, "Only white space is not allowed");
