...
<div class="m-portlet__body">
    ...
    @include('admin.common.upload-image',['image_name'=> 'image','new_image' =>old('image', $user->image),
    'current_image'=>imageUrl(old('image', $user->image_url), 100,100,90,1), 'title'=>'Display picture',
    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-9">
            <input  class="form-control " type="tel" name="phone" id="phone" value="{{ old('phone', $user->phone) }}" placeholder="895632542" required autocomplete="off"
    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-9">
            <input type="email" name="email" value="{{ old('email', $user->email) }}"
                class="form-control  f-input-cls dir rt-phone" placeholder="e.g johndoe@example.com" required
                autocomplete="off">
        </div>
    </div>
