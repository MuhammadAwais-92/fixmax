...
@push('script-page-level')
    ...
    <script>
        let id = "{{ $city->id }}";
        var latitude = {{ isset($city->latitude) ? $city->latitude : 25.204841 }};
        var longitude = {{ isset($city->longitude) ? $city->longitude : 55.270896 }};
        var mapId = 'map';
        var searchId = 'address';
        var latElement = 'latitude';
        var lngElement = 'longitude';
        var polygon = '{!! old('polygon', $city->polygon) !!}'
    ...
    @if ($city->id > 0)
        <script
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBNcTmnS323hh7tSQzFdwlnB4EozA3lwcA&libraries=drawing,places&callback=initializePolygon">
        </script>
    @else
        <script
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBNcTmnS323hh7tSQzFdwlnB4EozA3lwcA&libraries=drawing,places&callback=initialize">
        </script>
    @endif
