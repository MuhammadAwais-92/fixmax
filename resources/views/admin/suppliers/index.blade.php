...
@push('script-page-level')
    ...
    <script src="{{asset('assets/admin/js/adv_datatables/suppliers.js')}}" type="text/javascript"></script>
@endpush
...
@section('content')
    <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                     Suppliers
                        <small>
                            Here You Can Add, Edit or Delete Suppliers
                        </small>
                    </h3>
                </div>
            </div>
                ...
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <div class="m-dropdown m-dropdown--inline m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push" data-dropdown-toggle="hover" aria-expanded="true">
                            <a href="{!! route('admin.dashboard.suppliers.edit', 0) !!}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                <span>
                    ...
                    <div class="col-xl-12 order-2 order-xl-1">
                        <form class="form-group m-form__group row align-items-center" action="" id="manage-store-search">
                            <div class="col-md-12" style="margin-top: -22px;margin-bottom: 15px;">
                                <h3>Advance Search for Suppliers</h3>
                            </div>
                            {{--Name--}}
        ...
        <div class="m-portlet__body">
            ...
            <!--end: Search Form -->
            <!--begin: Datatable -->
            <div class="manage-stores" id="manage-stores">
            </div>
            <!--end: Datatable -->
        </div>
    </div>
