                ...
                <ul class="m-portlet__nav">
                    ...
                    <li class="m-portlet__nav-item">
                        ...
                        <div class="m-dropdown m-dropdown--inline m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push" data-dropdown-toggle="hover" aria-expanded="true">
                            ...
                            <a href="{!! route('admin.dashboard.administrators.create') !!}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                            ...
                            <div class="col-md-4 m--margin-bottom-10">
                                ...
                                <div class="m-form__group m-form__group--inline">
                                    ...
                                    <div class="m-form__control">
                                        ...
                                        <input type="text" class="form-control m-bootstrap-select" name="user_name" placeholder="User Name">
