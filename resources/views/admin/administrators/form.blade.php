{!! Form::model($selected_admin, ['url' => $action , 'method' => 'POST', 'role' => 'form', 'class' => 'm-form m-form--fit m-form--label-align-right', 'enctype' => 'multipart/form-data']) !!}
...
<div class="m-portlet__body">
    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-7">
            ...
            {!! Form::text('name', old('name'), ['class' => 'form-control', 'id' => 'full_name', 'placeholder' => 'Full Name', 'required' => 'required']) !!}
    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-7">
            ...
            {!! Form::email('email', old('email'), ['class' => 'form-control', 'id' => 'user_name', 'placeholder' => 'Username', 'required' => 'required']) !!}
    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-7">
            ...
            @else
                ...
                {!! Form::password('password_confirmation', ['class' => 'form-control', 'id' => 'password_confirmation', 'placeholder' => 'Password Confirmation', 'required' => 'required']) !!}
    ...
    <div class="m-form__actions">
        ...
        <div class="row">
            ...
            <div class="col-7">
                ...
                <a href="{!! route('admin.dashboard.administrators.index') !!}" class="btn btn-secondary m-btn m-btn--air m-btn--custom">Cancel</a>
