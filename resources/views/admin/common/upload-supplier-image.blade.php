...
<div class="form-group m-form__group row">
    ...
    <div class="col-3" id="display-selected-file-{{$image_number}}" >
        ...
        @else
        <a href="{{$current_light_image}}" data-lightbox="image-1"><img style="width:120px;height: 120px; " src="{{$current_image}}" id="selected-image-{{$image_number}}"
            class="selected-ima img-fluid"></a>
                ...
                $.ajax({
                    ...
                    .done(function (res) {
                        ...
                        if (res.success == false ) {
                            ...
                            if(res.data.match(/\.(jpeg|jpg|gif|png)$/) != null){
