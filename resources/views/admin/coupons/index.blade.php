                ...
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <div class="m-dropdown m-dropdown--inline m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push"
                            ...
                            <a href="{!! route('admin.dashboard.coupons.edit', 0) !!}"
                    ...
                    <div class="col-xl-12 order-2 order-xl-1">
                        <form class="form-group m-form__group row align-items-center" action="" id="manage-agency-search">
                            <div class="col-md-12" style="margin-top: -22px;margin-bottom: 15px;">
                                <h3>Advance Search for Coupons</h3>
                            </div>
                            ...
                            {{-- <div class="col-md-4 m--margin-bottom-10">
                                <div class="m-form__group m-form__group--inline">
                                    ...
                                    <div class="m-form__control">
                                        <input type="text" class="form-control m-bootstrap-select" name="status" placeholder="Status">
                                    </div>
                                </div>
                            </div> --}}
                            <div class="col-md-4 m--margin-bottom-10">
                                <div class="m-form__group m-form__group--inline">
                                    ...
                                    <div class="m-form__control">
                                        <select class="form-control" id="show-user-gender" name="status">
