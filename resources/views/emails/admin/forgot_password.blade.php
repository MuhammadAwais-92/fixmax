...
{{--                <a href="{!! route('admin.dashboard.index') !!}"><img  style="height: 90px " src=" {!! url(config('settings.email_header')) !!} " border="0" alt=""></a>--}}
            ...
            <a href="{!! route('admin.auth.forgot-password.show-reset-form', $token) !!}" style="width: 200px; height: 20px; background: #022C44; padding:10px 0; display: block; color: #fff; text-align: center; text-decoration:none; font-size: 14px;">Set New Password</a>
