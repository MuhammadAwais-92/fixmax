@extends('emails.user.layouts.app')
@section('content')
                ...
                <table width="90%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff"
                            ...
                            <table width="100%" cellpadding="12" cellspacing="0" border="0"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" valign="center" align="left"
                                        style="padding-left:15px;padding-right:15px;border-width:1px;border-color:#efefef;border-style:solid">{!! ucwords($subject) !!}</td>
                                </tr>
                                <tr>
                                    <td valign="center" align="left"
                                        style="width: 95px;padding-left:30px;padding-right:30px;border-width:1px;border-color:#efefef;border-style:solid">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" valign="center" align="left"
                                        style="padding-left:15px;padding-right:15px;border-width:1px;border-color:#efefef;border-style:solid">{!! $sender_email !!}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2" valign="center" align="left"
                                        style="padding-left:15px;padding-right:15px;border-width:1px;border-color:#efefef;border-style:solid">{!! $code !!}</td>
                                </tr>
                                </tbody>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td valign="top" align="left" style="padding-left:30px;padding-right:30px"><h2
                                style="margin-bottom: 0px;">{!! config('settings.company_name') !!}</h2></td>
                    </tr>
                    </tbody>
                </table>
            </td>
