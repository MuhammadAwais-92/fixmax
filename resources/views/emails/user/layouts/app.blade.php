                        ...
                        <table class="innermain" cellpadding="0" width="620" cellspacing="0" border="0" bgcolor="#F9F9F9" align="center" style="margin:0 auto;table-layout:fixed">
                            <tbody>
                                <tr>
            			        	...
            			        	<table class="m_logo" width="100%" cellpadding="0" cellspacing="0" border="0" background="{!!imageUrl(url(config('settings.email_header')),620,198, 100,1)  !!}">
            			        		<tbody>
            			        			...
            			        			<tr>
            			        				<td height="45px" align="center">
            			        					<table width="92%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="border-width:1px;border-color:#efefef;border-style:solid;border-bottom-width:0px;"><tbody><tr><td height="45px"></td></tr></tbody></table>
            			        				</td>
            			        			</tr>
                                        ...
                                        @yield('content')
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#022C44">
                                            <tbody>
                                                <tr>
                                                    <td height="50px" align="center">
                                                        <table width="92%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="border-width:1px;border-color:#efefef;border-style:solid;border-top-width:0px;"><tbody><tr><td height="50px"></td></tr></tbody></table>
                                                    </td>
                                                </tr>
                                                <tr><td height="30"></td></tr>
                                               <tr>
                                                   <td valign="middle" align="center" style="padding-left:30px;padding-right:30px">
                                                       <a href="{!! Config::get('settings.facebook_url') !!}" target="_blank" style="width:30px;height:26px;margin:0 5px;display:inline-block;"><img src="{{asset('assets/admin/email/facebook.png')}}" alt="facebook" width="24"/></a>
                                                       <a href="{!! Config::get('settings.twitter_url') !!}" target="_blank" style="width:30px;height:26px;margin:0 5px;display:inline-block;"><img src="{{asset('assets/admin/email/google.png')}}" alt="google" width="24"/></a>
...
<!--                                                         <a href="{!! Config::get('settings.youtube_url') !!}" style="width:30px;height:26px;margin:0 5px;display:inline-block;"><img src="{{asset('assets/front/email/youtube-logo.png')}}" alt="Youtube" width="24"/></a> -->
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tbody>
                                ...
                                <tr><td valign="top" align="center"><span style="color:#333;font-size:12px">© <a href="{!! url('/') !!}" style="color:#000;font-weight: 500; font-size:12px;text-decoration:none;">{!! config('settings.company_name') !!}</a> {!! \Carbon\Carbon::now()->format('Y') !!}</span></td></tr>
