        ...
        if (!is_null($package)) {
            foreach (cache('LANGUAGES') as $lang) {
                ...
                if (is_null($package->name)) {
                    $package->name = [];
                    $package->name += [$lang['short_code'] => ''];
                } else {
                    if (!array_key_exists($lang['short_code'], $package->name)) {
                ...
                if (is_null($package->description)) {
                    $package->description = [];
                    $package->description += [$lang['short_code'] => ''];
                } else {
                    if (!array_key_exists($lang['short_code'], $package->description)) {
