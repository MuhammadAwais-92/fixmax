...
class UserSubscriptionRepository extends Repository
{
    ...
    public function __construct(SubscriptionPackageRepository $subscriptionPackageRepository, UserRepository $userRepository, UserFeaturedSubscriptionRepository $userFeaturedSubscriptionRepository)
    {
        $this->setModel(new UserSubscription());
        $this->subscriptionPackageRepository = $subscriptionPackageRepository;
        $this->userRepository = $userRepository;
        $this->userFeaturedSubscriptionRepository = $userFeaturedSubscriptionRepository;
    ...
    public function paymentResponse(UserSubscriptionPaymentResponseDto $params)
    {
        ...
        if ($result->getState() == 'approved') {
            ...
            if ($params->subscription_type == 'featured') {

                $newUserFeatureSubscriptionCollection =  collect([
                    'user_id' => $user->id,
                    'package' => $package,
                    'is_expired' => false,
                ...
                $newUserFeatureSubscriptionDto = UserFeatureSubscriptionSaveDto::fromCollection($newUserFeatureSubscriptionCollection);
                return $this->userFeaturedSubscriptionRepository->save($newUserFeatureSubscriptionDto);
            } else {
