...
//    use RegistersUsers;
    ...
    public function callback(Request $request, $service)
    {
        ...
        if (!$userdata) {
            return redirect(route('front.auth.registration', ['platform' => $service, 'id' => $user->id, 'email' => $requestData['email'], 'user_name' => $requestData['full_name']." ".$requestData['last_name']]));
        }else{
