...
//use SendsPasswordResetEmails;
    ...
    public function forgotPassword(UserRequest $request)
    {
        try {
            ...
            if ($user) {
                ...
                return redirect(route('front.auth.show.reset.form'))->with('status', __('Password reset code has been sent'));
            }
        }catch (Exception $e){
    ...
    public function forgotPasswordResend(Request $request)
    {
        try {
            ...
            if ($email) {
                return responseBuilder()->success(__('Password reset code resent successfully.'));
            }
        }catch (Exception $e){
