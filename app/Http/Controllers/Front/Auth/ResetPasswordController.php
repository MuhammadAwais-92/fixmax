...
class ResetPasswordController extends Controller
{
    ...
    public function showResetForm()
    {
        ...
        $this->breadcrumbs['javascript: {};'] = ['title' => __('Reset Password')];

        return view('front.auth.reset-password', ['email'=>session('email')]);
    }
    ...
    public function resetPassword(Request $request)
    {
        try {
            ...
            return redirect(route('front.auth.login'))->with('status', __('Password successfully updated'));
        }catch (\Exception $e){
