...
class SendEmailDto extends DataTransferObject
{
   ...
   public array $data = [];
    ...
    {
        return new self([
            'reply_to' => $params->get('reply_to',config('settings.email', 'no-reply@kilogram.com')),
            'return_path' => $params->get('return_path',config('settings.email','no-reply@kilogram.com')),
